...
# Change Log
2020-11-24 \[BUG]: Added try-catch clause to StyleParser.processRuleSets() to catch exceptions caused by malformed CSS rule sets ([#Issue 30](https://github.com/sjb-ch1mp/LinkRippr/issues/30))
